        ...
        <BrowserRouter>
          <Switch>
            ...
            <ProtectedRoute exact path="/movies" loggedIn={loggedIn}>
              <Movies key="all-movies" type="all-movies" isLoading={isLoading} cards={allCards}
            ...
            <ProtectedRoute exact path="/profile" loggedIn={loggedIn}>
              ...
              <Profile onUpdateUser={handleUpdateUser} onLogout={onLogout} errorMessage={errorMessage}
                       setErrorMessage={setErrorMessage}
                       successMessage={successMessage}/>
            </ProtectedRoute>

            <ProtectedRoute exact path="/saved-movies" loggedIn={loggedIn}>
              <Movies key="saved-movies" type="saved-movies" isLoading={isLoading} cards={likedCards}
