...
function Profile({onUpdateUser, onLogout, errorMessage, setErrorMessage, successMessage}) {
        ...
        <section className="profile">
          ...
          <form className="profile__person" noValidate onSubmit={handleUpdateUser}>
            <label className="profile__input-area">
              ...
              <input type="text" name="personName" className="profile__input" value={values.personName || ""}
                     onChange={handleChangeName} placeholder='Имя'
